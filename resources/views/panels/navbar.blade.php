    ...
    <div class="navbar-container d-flex content">
        <div class="bookmark-wrapper d-flex align-items-center">
          ...
          <ul class="nav navbar-nav bookmark-icons align-items-center">
            <li class="nav-item mr-4"><h3 class="mb-0 text-primary">Dev-Partners</h3></li>
            <li class="nav-item mr-1"><h5 class="mb-0">Home</h5></li>
            <li class="nav-item mr-1"><h5 class="mb-0">Devs</h5></li>
            <li class="nav-item mr-1"><h5 class="mb-0">Projects</h5></li>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="user-nav font-weight-bolder">

    ...
    <div class="user-chats">
      <div id="chats" class="chats">
        ...
        <div class="chat chat-left">
          ...
          <div class="chat-body">
            <div class="chat-content">
              <p>Hey John, I am looking for GOOD UI.</p>
        ...
        <div class="chat chat-left">
          ...
          <div class="chat-body">
            <div class="chat-content ">
              <p>I will learn it for sure. 👍</p>
              <div class="d-flex justify-content-end">
                <div></div>
                <div><small class="font-weight-lighter align-content-around">19:30</small>
                </div>
              </div>
            </div>
            <div class="chat-content">
        ...
        <div class="chat">
          ...
          <div class="chat-body">
            <div class="chat-content">
              ...
              <small class="font-weight-lighter">19:30</small>
              </div>
            <div class="chat-content">
              <div class="d-flex">
                <div class="mr-2"><p>FileName.pdf</p></div>
                <div class="icon-wrapper">
                  <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-down-circle">
